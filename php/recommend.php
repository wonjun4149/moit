...
<body>
    <div class="container">
            ...
            <?php else: ?>
                <?php foreach ($recommendations as $rec): ?>
                    <div class="item">
                        ...
                        <a href="meeting_detail.php?id=<?= urlencode($rec['meeting_id']) ?>&from=recommend" class="btn btn-back" style="float: right;">상세 보기</a>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
        ...
        <div class="btn-group">
            <a href="create_confirmed.php" class="btn btn-create">새로 만들기</a>
